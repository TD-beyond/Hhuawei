...
$details = $_REQUEST['details'];//商品price
...
if($rows>0){
	...
	$sql = "INSERT INTO `cart` (`product_id`,`product_img`,`product_name`,`product_num`,`product_price`,`product_details`) VALUES ('$id','$img','$name','1','$price','$details')";
}
